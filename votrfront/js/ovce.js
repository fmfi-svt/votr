...
function createDiv() {
  ...
  div.innerHTML += '<link href="https://fonts.googleapis.com/css?family=Open+Sans&amp;subset=latin-ext" rel="stylesheet"><div class="ovca__wrap"><div class="ovca__container"><div class="ovca__text">Nebuď ovca!</div><img src="http://i.imgur.com/7YWj2E6.png" alt="Lietajuca ovecka" class="ovca__image" /><div class="ovca__button-wrap"><a class="ovca__button ovca__button--red" href="http://anketa.fmph.uniba.sk?ovca" target="_blank" rel="noopener noreferrer" onclick="removeMe(window.cookieDurationVote);>Hlasuj</a><a class="ovca__button ovca__button--white" href="javascript:void(0);" onclick="removeMe(window.cookieDurationClose);">Zatvor</a></div></div></div>';
